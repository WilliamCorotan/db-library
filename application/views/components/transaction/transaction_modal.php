                ...
                <div class="row px-4 py-3">
                    <div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div>
                                <input type="text" class="form-control" name="title" id="edit-title" aria-describedby="titleId" placeholder="Book Title">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div>
                                <input type="date" class="form-control" name="borrow_date" id="edit-borrow_date" aria-describedby="borrowDateId" placeholder="Borrow Date">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="first_name" id="edit-first_name" aria-describedby="firstNameId" placeholder="First Name">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="last_name" id="edit-last_name" aria-describedby="lastNameId" placeholder="Last Name">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="contact_number" id="edit-contact_number" aria-describedby="contactNumberId" placeholder="Contact Number">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="return_status_id" id="edit-return_status_id">
